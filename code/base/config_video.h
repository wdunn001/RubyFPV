...
#define DEFAULT_VIDEO_END_FRAME_DETECTION_TIMEOUT 6
...
#define DEFAULT_VIDEO_FPS_OIPC_SIGMASTAR 30

#define DEFAULT_LOWEST_ALLOWED_ADAPTIVE_VIDEO_BITRATE 750000
