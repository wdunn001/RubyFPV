...
MODULE_VEHICLE := $(FOLDER_VEHICLE)/shared_vars.o $(FOLDER_VEHICLE)/timers.o $(FOLDER_VEHICLE)/adaptive_video.o $(FOLDER_VEHICLE)/negociate_radio.o $(FOLDER_VEHICLE)/generic_tx_ecbuffers.o $(FOLDER_UTILS)/utils_vehicle.o $(FOLDER_VEHICLE)/launchers_vehicle.o $(FOLDER_BASE)/vehicle_rt_info.o $(FOLDER_VEHICLE)/dynamic_rssi_thresholds.o $(FOLDER_VEHICLE)/qp_delta_config.o $(FOLDER_VEHICLE)/rubalink_integration.o $(FOLDER_VEHICLE)/advanced_signal_processing.o $(FOLDER_VEHICLE)/independent_signal_sampling.o $(FOLDER_VEHICLE)/enhanced_cooldown_control.o $(FOLDER_VEHICLE)/racing_mode_enhancements.o $(FOLDER_VEHICLE)/rubalink_seamless_integration.o $(FOLDER_VEHICLE)/signal_pattern_analysis.o $(FOLDER_VEHICLE)/fallback_logic.o $(FOLDER_BASE)/robust_command_execution.o
...
# AP-ALINK-FPV UI Components
CENTRAL_RUBALINK := $(FOLDER_CENTRAL)/rubalink_monitoring_display.o $(FOLDER_CENTRAL)/rubalink_api_endpoints.o
